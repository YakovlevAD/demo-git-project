...
class ProfileViewController:UIViewController {
    ...
    let aboutMeLabel = UILabel(text: "You hava the opportunity to chat with best man in the world", font: .systemFont(ofSize: 16, weight: .light))
    ...
    @objc private func sendMessage() {
        ...
        self.dismiss(animated: true) {
            ...
            //TODO: UIApplication.getTopViewController()?.showAlert(with: "Тест", and: "111")
        }
    }
