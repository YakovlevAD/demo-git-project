...
//  Chat
//
//  Created by Alexandr Yakovlev on 25.01.2022.
//
...
extension ChatsViewController {
    ...
    func configureSendButton() {
        messageInputBar.sendButton.setImage(UIImage(named: "Button send"), for: .normal)
...
extension ChatsViewController: MessagesDisplayDelegate {
    ...
    func avatarSize(for message: MessageType, at indexPath: IndexPath, in messageCollectionView: MessagesCollectionView) -> CGSize {
        return .zero
    }
...
extension ChatsViewController: InputBarAccessoryViewDelegate {
    func inputBar(_ inputBar: InputBarAccessoryView, didPressSendButtonWith text: String) {
        ...
        print("send message from #\(user)# text #\(text)#")
