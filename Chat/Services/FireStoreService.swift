...
class FirestoreService {
    ...
    func getUserData(user: User, completion: @escaping  (Result<MUser,Error>) -> Void) {
        ...
        docRef.getDocument {
            (document, error) in
            if let document = document, document.exists { //TODO: - что за запись такая? document, document.exists {}
    ...
    func saveProfileWith(id: String, email: String, username: String?, avatarImage: UIImage?, description: String?, sex: String?, completion: @escaping  (Result<MUser,Error>) -> Void) {
        ...
        guard avatarImage != #imageLiteral(resourceName: "image") else {
    ...
    func crateWaitingChat(message: String, reciver: MUser, completion: @escaping  (Result<Void,Error>) -> Void) {
